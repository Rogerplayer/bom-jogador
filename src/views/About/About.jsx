  ...
  return (
    <DocPage title='Sobre o "Bom Jogador"'>
      <DocSection heading="O projeto">
        <p>
          Bom Jogador é um trabalho acadêmico da pós-graduação em Arquitetura
          de Software, módulo de Arquitetura Front-end. A proposta original do
          professor era listar filmes populares e seus detalhes usando uma API
          gratuita. A ideia aqui foi ir além: trocar filmes por{' '}
